...
export const readUser = createAsyncThunk("readUser", async () => {
  try {
    const res = await fetch(
      "https://tweet-it-kappa.vercel.app/api/users/user/id/66e183147b64fafc1e2fa38a"
    );
...
export const editUser = createAsyncThunk("editUser", async ({ userData }) => {
  try {
    const res = await fetch(
      "https://tweet-it-kappa.vercel.app/api/users/user/edit/66e183147b64fafc1e2fa38a",
      {
        method: "POST",
        headers: {
